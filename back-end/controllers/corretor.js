...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Corretor.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Corretor.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Corretor.findByIdAndDelete(id)
