...
controller.novo = async (req, res) => {
    try {
        ...
        await Complemento.create(req.body)
        // HTTP 201: Created
        res.status(201).end()
    }
    catch (erro) {
...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Complemento.find()
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Complemento.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Complemento.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Complemento.findByIdAndDelete(id)
