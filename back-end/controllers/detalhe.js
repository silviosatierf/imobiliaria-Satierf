...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Detalhe.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Detalhe.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Detalhe.findByIdAndDelete(id)
