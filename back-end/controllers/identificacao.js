...
controller.novo = async (req, res) => {
    try {
        ...
        await Identificacao.create(req.body)
        // HTTP 201: Created
        res.status(201).end()
    }
    catch (erro) {
...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Identificacao.find()
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Identificacao.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Identificacao.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Identificacao.findByIdAndDelete(id)
